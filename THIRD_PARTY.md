...
| [HashiCorp Terraform](https://github.com/hashicorp/terraform) | inherited image package | BUSL-1.1 | https://github.com/hashicorp/terraform | `aicodebox:v0.15.1-full` only | Source-available, non-compete license, not OSI-approved open source. Corresponding source at the upstream repo above. See the FLAG in the project docs. |
| [GitHub CLI (`gh`)](https://github.com/cli/cli) | inherited image package | MIT | https://github.com/cli/cli | `aicodebox:v0.15.1-full` only | |
| [kubectl](https://github.com/kubernetes/kubectl) | inherited image package | Apache-2.0 | https://github.com/kubernetes/kubectl | `aicodebox:v0.15.1-full` only | |
| [Helm](https://github.com/helm/helm) | inherited image package | Apache-2.0 | https://github.com/helm/helm | `aicodebox:v0.15.1-full` only | |
| [golangci-lint](https://github.com/golangci/golangci-lint) | inherited image package | BSD-3-Clause | https://github.com/golangci/golangci-lint | `aicodebox:v0.15.1-full` only | |
